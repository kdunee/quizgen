...
if __name__ == "__main__":
    ...
    parser.add_argument("--chapter-path", type=str)
    parser.add_argument("--title", type=str)
    parser.add_argument("--output-path", type=str)
    parser.add_argument("--concept-model", type=str, default="gpt-4o-mini-2024-07-18")
    parser.add_argument("--questions-model", type=str, default="gpt-4o-2024-08-06")
